...
function setup() {
  ...
  division3= new Division(240,750,10,200);
    ...
    box2=new Box(120,100,10,10)
    box3=new Box(140,100,10,10)
    box4=new Box(160,100,10,10)
    box5=new Box(180,100,10,10)
    box6=new Box(110,50,10,10)
    box7=new Box(130,50,10,10)
    box8=new Box(170,50,10,10)
    box9=new Box(190,50,10,10)
    box10=new Box(200,50,10,10)
